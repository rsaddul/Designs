...
$ExportPath = "C:\Users\RhysSaddul\OneDrive - eduthing\Documents\BFLT\Guests_Export.csv"

# Connect to Microsoft Graph
Connect-MgGraph -Scopes 'User.Read.All' -NoWelcome | Out-Null

# Retrieve Office 365 guests and their IDs
$GuestUserIds = Get-MgUser -All -Filter "UserType eq 'Guest'" | Select-Object -ExpandProperty Id
...
# Export guest users to CSV file with ordered columns
