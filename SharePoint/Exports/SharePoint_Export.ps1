...
$dialogResult = [System.Windows.Forms.MessageBox]::Show("Have you set the varible for SharePoint Online?", "Variable Setup", "YesNo", "Question")
...
# Varibles
Connect-PnPOnline -Url "https://goldsworth-admin.sharepoint.com/" -Interactive # Admin SharePoint Online URL
$outputFilePath = "C:\Users\RhysSaddul\OneDrive - eduthing\Documents\BFLT\365_SharePoint_Sites.csv" # Define output file path
