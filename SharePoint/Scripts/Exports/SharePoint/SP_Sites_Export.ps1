...
# Varibles
Connect-PnPOnline -Url "https://smjs-admin.sharepoint.com/" -Interactive # Admin SharePoint Online URL
$outputFilePath = "C:\Users\RhysSaddul\OneDrive - eduthing\Documents\SMPS\Exports\SharePoint\SP_Sites_Export.csv" # Define output file path
